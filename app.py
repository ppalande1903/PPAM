...
if sidebar_main == 'Home' : 
    st.title('PPAM PERSONAL FINANCE DASHBOARD')
    st.markdown("""
        #####  This base level personal finance dashboard has been made to keep our personal wallet in check.
    """)
    ...
    st.markdown("""
    ###### the summary of your expense is as follows:
    """)
    ...
    st.markdown(
            """
            ##### a detailed table of your food habits is as follows:
            """
        )
    ...
    if sidebar_sub == 'Expense' : 
        ...
        st.markdown(
            """
            ##### graph of your expense; as per your desired algorithmic flow:
            """
        ) 
